---
title: Support Vector Machines (Linear)
...
tags: []
subtitle: ''
summary: 'This post is about linear Support Vector Machines; currently just implementation in R, hopefully will soon update to include the theory of the method'
authors: []
lastmod: '2021-04-23T21:32:19-04:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
social_network_ads <- fread("C:/Users/diji_/Desktop/Data Science/Machine Learning A-Z (Codes and Datasets)/Part 3 - Classification/Section 16 - Support Vector Machine (SVM)/R/Social_Network_Ads.csv")
```
...
svm_linear <- svm(Purchased ~ Age + EstimatedSalary, data = training_set, type = "C-classification", kernel = "linear")
summary(svm_linear)
```
...
```{r}
y_grid_pred <- predict(svm_linear, the_grid)
```
...
ggplot() +
  ...
  xlab("Salary") +
  ylab("Age") +
  ggtitle("SVM used to predict purchase of an item based on age and salary.") +
  theme_classic()
```
