...
svm_linear <- svm(Purchased ~ Age + EstimatedSalary, data = training_set, type = "C-classification", kernel = "radial")
summary(svm_linear)
```
...
ggplot() +
  ...
  xlab("Salary") +
  ylab("Age") +
  ggtitle("SVM with radial basis kernel used to predict purchase of an item based on age and salary.") +
  theme_classic() +
